...
<?php
    ...
    if ( !empty($node->field_program_public_poc_email['und'][0]['value']) || !empty($node->field_program_public_poc_phone['und'][0]['value']) ) {
...
<div id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> with-padding" rendersource="<?php print basename(__FILE__); ?>">
    ...
    <div class="row no-margin node-landing-toparea">
        <div class="<?php if ( $dblCoulmnLayout ){ print 'col-sm-6';}else{ print 'col-sm-12';} ?>"> 
            ...
            <div class="detail-descr">
                <?php print check_markup($node->field_program_detail_desc['und'][0]['value'], $node->field_program_detail_desc['und'][0]['format']); ?>
            </div>

            <!-- ELIGIBILITY -->
            <?php if ( !empty($node->field_program_eligibility['und'][0]['value']) ): ?>
                <div class="node-fieldlabelvalue field_program_eligibility">
                    <span class="fieldlabel">Eligibility:</span>
                    <span class="fieldvalue">
                        <?php /* print check_markup($node->field_program_eligibility['und'][0]['value'], $node->field_program_eligibility['und'][0]['format']); */ ?>
            ...
            <!-- LEARN MORE (LINK) -->
            <?php if ( !empty($node->field_program_ext_url['und'][0]['url']) ): ?>
                <div class="node-fieldlabelvalue field_program_ext_url">
                    ...
                    <span class="fieldvalue">
                        <a href="<?php print $node->field_program_ext_url['und'][0]['url']; ?>">
                            <?php print $node->field_program_ext_url['und'][0]['url']; ?>
                        </a>
                    </span>
                </div>
            <?php endif; ?>
            ...
            <div id="addtags" style="display: none;">
                <form action="javascript: jQuery.post('/sys/suggest-tag-receiver', jQuery('#tagsform').serialize(), function(data) { jQuery.colorbox( {'html': data} ); }); void(0);" id='tagsform'>
                    ...
                    <div class="tag-labelinput">
                        ...
                        <input placeholder="Technology, Transfer, Federal" name="tags" id="tags" class="form-control" type="text" />
                    </div>
                    <br>
        ...
        <?php if ( $dblCoulmnLayout ): ?>
            <div class="<?php if ( $dblCoulmnLayout ) print 'col-sm-6'; ?>"> 
                ...
                <div class="contactinfo-container">
                    <h2>Contact</h2>
                    <?php if ( !empty($node->field_program_public_poc_org['und'][0]['value']) ): ?>
                        <!-- CONTACT ORGANIZATION-->
                        <div class="contactinfo-organization">
                            <?php 
                                $fieldInfo = field_info_field('field_program_public_poc_org');
                                $keyToLabelMappings = $fieldInfo['settings']['allowed_values'];
                                $key = $node->field_program_public_poc_org['und'][0]['value'];
                    ...
                    <ul class="contactinfo-list">
                        ...
                        <?php if ( !empty($node->field_program_public_poc_name['und'][0]['value']) ): ?>
                            <li class="contactinfo-item">
                                ...
                                <span class="contactinfo-fieldvalue">
                                    <?php print $node->field_program_public_poc_name['und'][0]['value']; ?>
                                </span>
                            </li>
                        <?php endif; ?>
                        
                        <?php if ( !empty($node->field_program_public_poc_email['und'][0]['value']) ): ?>
                            <li class="contactinfo-item">
                                <!-- CONTACT EMAIL-->
                                ...
                                <span class="contactinfo-fieldvalue">
                                    <a href="mailto: <?php print $node->field_program_public_poc_email['und'][0]['value']; ?>">
                                        <?php print $node->field_program_public_poc_email['und'][0]['value']; ?>
                                    </a>
                                </span>
                            </li>
                        <?php endif; ?>
                        
                        <?php if ( !empty($node->field_program_public_poc_phone['und'][0]['value']) ): ?>
                            <li class="contactinfo-item">
                                ...
                                <span class="contactinfo-fieldvalue">
                                    <a href="tel: <?php print $node->field_program_public_poc_phone['und'][0]['value']; ?>">
                                        <?php print $node->field_program_public_poc_phone['und'][0]['value']; ?>
                                    </a>
                                </span>
                            </li>
                        <?php endif; ?>
