    ...
    var addCheckableEvents = function (element) {
        ...
        element.find('a:first, label').on('click', function(e){
            ...
            if (window.ko) {
                ...
                input.click(); // The actual click event NEEDS to be fired, other jQuery code depends on this (dmhf)
    ...
    Plugin.prototype = {
        ...
        init: function ( options ) {
            ...
            if (labelPosition === 'labelright') {
                ...
                dom.push('<a href="javascript: // " class="' + ( el.prop('checked') ? 'checked' : '' ) + ' ' + disabled + '"></a>'); // Edited to stop the page from needlessly scrolling (dmhf)
